...
Zope Toolkit 1.1c1 packages
===========================

See :ref:`overview-1.1c1`.
...
.. list-table::
    ...
    * - `zope.dublincore <http://pypi.python.org/pypi/zope.dublincore/3.8.1>`_
      - 3.8.1
    ...
    * - `zope.security <http://pypi.python.org/pypi/zope.security/3.8.0>`_
      - 3.8.0
    ...
    * - `zope.server <http://pypi.python.org/pypi/zope.server/3.8.2>`_
      - 3.8.2
    ...
    * - `zope.testrunner <http://pypi.python.org/pypi/zope.testrunner/4.0.0>`_
      - 4.0.0
    ...
    * - `zope.traversing <http://pypi.python.org/pypi/zope.traversing/3.13.1>`_
      - 3.13.1
