...
Zope Toolkit 1.0c1 packages
===========================

See :ref:`overview-1.0c1`.
...
.. list-table::
    ...
    * - `Sphinx <http://pypi.python.org/pypi/Sphinx/1.0.3>`_
      - 1.0.3
    ...
    * - `mechanize <http://pypi.python.org/pypi/mechanize/0.2.2>`_
      - 0.2.2
      - Stateful programmatic web browsing.
      - 

    * - `mr.developer <http://pypi.python.org/pypi/mr.developer/1.15>`_
      - 1.15
