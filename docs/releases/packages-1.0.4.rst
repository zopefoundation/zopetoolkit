...
Zope Toolkit 1.0.4 packages
===========================

See :ref:`overview-1.0.4`.
...
.. list-table::
    ...
    * - `PasteScript <http://pypi.python.org/pypi/PasteScript/1.7.4.2>`_
      - 1.7.4.2
    ...
    * - `distribute <http://pypi.python.org/pypi/distribute/0.6.21>`_
      - 0.6.21
