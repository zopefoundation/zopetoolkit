...
Zope Toolkit 1.0c3 packages
===========================

See :ref:`overview-1.0c3`.
...
.. list-table::
    ...
    * - `zope.error <http://pypi.python.org/pypi/zope.error/3.7.1>`_
      - 3.7.1
    ...
    * - `zope.publisher <http://pypi.python.org/pypi/zope.publisher/3.12.4>`_
      - 3.12.4
    ...
    * - `zope.schema <http://pypi.python.org/pypi/zope.schema/3.7.0>`_
      - 3.7.0
    ...
    * - `zope.sendmail <http://pypi.python.org/pypi/zope.sendmail/3.7.3>`_
      - 3.7.3
      - Zope sendmail
    ...
    * - `zope.session <http://pypi.python.org/pypi/zope.session/3.9.3>`_
      - 3.9.3
    ...
    * - `zope.testing <http://pypi.python.org/pypi/zope.testing/3.9.5>`_
      - 3.9.5
...
.. list-table::
    ...
    * - `ClientForm <http://pypi.python.org/pypi/ClientForm/0.2.10 # needed for mechanize 0.1.x>`_
      - 0.2.10 # needed for mechanize 0.1.x
      - Client-side HTML form handling.
      - 

    * - `Jinja2 <http://pypi.python.org/pypi/Jinja2/2.5.2>`_
      - 2.5.2
    ...
    * - `Sphinx <http://pypi.python.org/pypi/Sphinx/1.0.4>`_
      - 1.0.4
    ...
    * - `ZODB3 <http://pypi.python.org/pypi/ZODB3/3.9.6>`_
      - 3.9.6
    ...
    * - `distribute <http://pypi.python.org/pypi/distribute/0.6.14>`_
      - 0.6.14
    ...
    * - `mechanize <http://pypi.python.org/pypi/mechanize/0.1.11 # newer versions are not fully py24 compatible>`_
      - 0.1.11 # newer versions are not fully py24 compatible
      - Stateful programmatic web browsing.
      - 

    * - `mr.developer <http://pypi.python.org/pypi/mr.developer/1.16>`_
      - 1.16
    ...
    * - `pytz <http://pypi.python.org/pypi/pytz/2010l>`_
      - 2010l
