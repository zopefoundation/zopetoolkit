...
Zope Toolkit 1.1.2 packages
===========================

See :ref:`overview-1.1.2`.
...
.. list-table::
    ...
    * - `zope.contenttype <http://pypi.python.org/pypi/zope.contenttype/3.5.3>`_
      - 3.5.3
      - Zope contenttype
    ...
    * - `zope.error <http://pypi.python.org/pypi/zope.error/3.7.2>`_
      - 3.7.2
    ...
    * - `zope.formlib <http://pypi.python.org/pypi/zope.formlib/4.0.5>`_
      - 4.0.5
    ...
    * - `zope.interface <http://pypi.python.org/pypi/zope.interface/3.6.3>`_
      - 3.6.3
    ...
    * - `zope.security <http://pypi.python.org/pypi/zope.security/3.8.2>`_
      - 3.8.2
    ...
    * - `zope.server <http://pypi.python.org/pypi/zope.server/3.8.4>`_
      - 3.8.4
    ...
    * - `zope.session <http://pypi.python.org/pypi/zope.session/3.9.4>`_
      - 3.9.4
    ...
    * - `zope.testing <http://pypi.python.org/pypi/zope.testing/3.10.2>`_
      - 3.10.2
    ...
    * - `zope.testrunner <http://pypi.python.org/pypi/zope.testrunner/4.0.3>`_
      - 4.0.3
...
.. list-table::
    ...
    * - `Sphinx <http://pypi.python.org/pypi/Sphinx/1.0.7>`_
      - 1.0.7
    ...
    * - `ZODB3 <http://pypi.python.org/pypi/ZODB3/3.10.3>`_
      - 3.10.3
    ...
    * - `distribute <http://pypi.python.org/pypi/distribute/0.6.19>`_
      - 0.6.19
    ...
    * - `mr.developer <http://pypi.python.org/pypi/mr.developer/1.17>`_
      - 1.17
      - A zc.buildout extension to ease the development of large projects with lots of packages.
      - 

    * - `py <http://pypi.python.org/pypi/py/1.4.3>`_
      - 1.4.3
    ...
    * - `python-subunit <http://pypi.python.org/pypi/python-subunit/0.0.6>`_
      - 0.0.6
      - Python implementation of subunit test streaming protocol
      - 

    * - `pytz <http://pypi.python.org/pypi/pytz/2011g>`_
      - 2011g
    ...
    * - `testtools <http://pypi.python.org/pypi/testtools/0.9.10>`_
      - 0.9.10
    ...
    * - `zc.resourcelibrary <http://pypi.python.org/pypi/zc.resourcelibrary/1.3.2>`_
      - 1.3.2
