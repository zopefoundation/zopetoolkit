...
Zope Toolkit 1.0a1 packages
===========================

See :ref:`overview-1.0a1`.
...
.. list-table::
    ...
    * - `zope.exceptions <http://pypi.python.org/pypi/zope.exceptions/3.6.0>`_
      - 3.6.0
      - Zope Exceptions
    ...
    * - `zope.formlib <http://pypi.python.org/pypi/zope.formlib/4.0.3>`_
      - 4.0.3
    ...
    * - `zope.i18n <http://pypi.python.org/pypi/zope.i18n/3.7.3>`_
      - 3.7.3
    ...
    * - `zope.index <http://pypi.python.org/pypi/zope.index/3.6.0>`_
      - 3.6.0
    ...
    * - `zope.pagetemplate <http://pypi.python.org/pypi/zope.pagetemplate/3.5.1>`_
      - 3.5.1
      - Zope Page Templates
    ...
    * - `zope.proxy <http://pypi.python.org/pypi/zope.proxy/3.6.0>`_
      - 3.6.0
    ...
    * - `zope.traversing <http://pypi.python.org/pypi/zope.traversing/3.12.1>`_
      - 3.12.1
...
.. list-table::
    ...
    * - `RestrictedPython <http://pypi.python.org/pypi/RestrictedPython/3.5.1>`_
      - 3.5.1
    ...
    * - `docutils <http://pypi.python.org/pypi/docutils/0.6>`_
      - 0.6
    ...
    * - `py <http://pypi.python.org/pypi/py/1.3.1>`_
      - 1.3.1
    ...
    * - `z3c.checkversions <http://pypi.python.org/pypi/z3c.checkversions/0.2>`_
      - 0.2
