...
Zope Toolkit 1.1.5 packages
===========================

See :ref:`overview-1.1.5`.
...
.. list-table::
    ...
    * - `zope.tales <http://pypi.python.org/pypi/zope.tales/3.5.2>`_
      - 3.5.2
...
.. list-table::
    ...
    * - `distribute <http://pypi.python.org/pypi/distribute/0.6.27>`_
      - 0.6.27
    ...
    * - `py <http://pypi.python.org/pypi/py/1.4.8>`_
      - 1.4.8
    ...
    * - `pytz <http://pypi.python.org/pypi/pytz/2012c>`_
      - 2012c
